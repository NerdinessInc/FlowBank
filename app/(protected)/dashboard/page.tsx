        ...
        <main className='h-full w-full flex flex-col gap-6'>
            ...
            <div className='grid gap-2 md:grid-cols-3'>
                <Card x-chunk='dashboard-01-chunk-0'>
                    ...
                    <CardContent>
                        <div className='text-2xl font-bold'>{userData?.acctCollection?.AcctStruct?.slice(1, 2)?.[0].AccountNumber}</div>
                    </CardContent>
                </Card>
                ...
                <Card x-chunk='dashboard-01-chunk-1'>
                    ...
                    <div className='text-2xl font-bold'>
                        {userData?.acctCollection?.AcctStruct?.slice(1, 2)?.[0].AccountNumber 
                        ? userData?.acctCollection?.AcctStruct?.slice(1, 2)?.[0].AccountNumber 
                ...
                <Card x-chunk='dashboard-01-chunk-2'>
                    ...
                    <CardContent>
                        <div className='text-2xl font-bold'>{userData?.acctCollection?.AcctStruct?.slice(1, 2)?.[0].IsoCurrencyName
}</div>
                    </CardContent>
                </Card>
            </div>
